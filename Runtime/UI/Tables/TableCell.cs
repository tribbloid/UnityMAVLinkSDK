...
namespace MAVLinkSDK.UI.Tables
{
    ...
    public class TableCell : HorizontalLayoutGroup
    {
        ...
        [Tooltip(
            "If this property is set, then this cell will ignore the TableLayout CellBackgroundColor/CellBackgroundImage values - allowing you to set specific values for this cell.")]
        public bool dontUseTableCellBackground = false;

        [Tooltip(
            "If this property is set, then this cell will ignore the TableLayout Global Cell Padding values - allowing you to set specific values for this cell.")]
        public bool overrideGlobalPadding = false;

        [NonSerialized] internal float actualWidth = 0f;
        [NonSerialized] internal float actualHeight = 0f;
        [NonSerialized] internal float actualX = 0f;
        [NonSerialized] internal float actualY = 0f;
        ...
        [SerializeField] private TableLayout m_tableLayout = null;
        [SerializeField] private TableRow m_tableRow = null;
